...
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/ibm.com_IBM_MQ_Advanced_Message_Security-9.4.0.swidtag $RPM_BUILD_ROOT/opt/mqm/swidtag/ibm.com_IBM_MQ_Advanced_Message_Security-9.4.0.swidtag
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/swidtag/ibm.com_IBM_MQ_Advanced_Message_Security-9.4.0.swidtag
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/lib/smqcert.lic $RPM_BUILD_ROOT/opt/mqm/lib/smqcert.lic
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/lib/smqcert.lic

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/lib"
%attr(444,mqm,mqm) %config(missingok) "/opt/mqm/swidtag/ibm.com_IBM_MQ_Advanced_Message_Security-9.4.0.swidtag"
