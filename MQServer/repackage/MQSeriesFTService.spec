...
Requires: MQSeriesFTAgent = 9.4.0-0
...
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/ibm.com_IBM_MQ_Managed_File_Transfer_Service-9.4.0.swidtag $RPM_BUILD_ROOT/opt/mqm/swidtag/ibm.com_IBM_MQ_Managed_File_Transfer_Service-9.4.0.swidtag
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/swidtag/ibm.com_IBM_MQ_Managed_File_Transfer_Service-9.4.0.swidtag
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml $RPM_BUILD_ROOT/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/mqft/lib/agenttype.properties $RPM_BUILD_ROOT/opt/mqm/mqft/lib/agenttype.properties
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/mqft/lib/agenttype.properties
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/fteCreateBridgeAgent $RPM_BUILD_ROOT/opt/mqm/bin/fteCreateBridgeAgent
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/fteCreateBridgeAgent
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/fteSetAgentLogLevel $RPM_BUILD_ROOT/opt/mqm/bin/fteSetAgentLogLevel
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/fteSetAgentLogLevel
...
%attr(444,mqm,mqm) %config(missingok) "/opt/mqm/swidtag/ibm.com_IBM_MQ_Managed_File_Transfer_Service-9.4.0.swidtag"
