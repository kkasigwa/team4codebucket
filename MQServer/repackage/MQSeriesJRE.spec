...
5724-H72 
This package provides an IBM Java Runtime for running the Java
...
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_JRE-1.8.0.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_JRE-1.8.0.mqtag
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_JRE-1.8.0.mqtag
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/java/jre64/mq_jre64.tar.gz $RPM_BUILD_ROOT/opt/mqm/java/jre64/mq_jre64.tar.gz
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/java/jre64/mq_jre64.tar.gz
...
# @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/jre_postinstall.sh
#   <copyright 
#   notice="lm-source-program" 
#   pids="5724-H72," 
#   years="2004,2023" 
...
JAVA_HOME=`echo ${MQ_INSTALLATION_PATH}/java/jre64 | sed s#//#/#g`
if [ -r ${JAVA_HOME}/mq_jre64.tar.gz ]  
then 
  cd ${JAVA_HOME}
  tar ${TARFLAGS} mq_jre64.tar.gz 
  tarrc=$?
  if [ ${tarrc} -ne 0 ]
    then 
      echo "WARNING: Return code \"${tarrc}\" from tar while expanding \"${MQ_INSTALLATION_PATH}/java/jre64/mq_jre64.tar.gz\""
    else 
      chown -h -R mqm:mqm .
      chmod -R o-w,g-w,u-w .
  fi
...
# @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/jre_preuninstall.sh
#   <copyright 
#   notice="lm-source-program" 
#   pids="5724-H72," 
#   years="2004,2020" 
...
# @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/jre_posttrans.sh
#   <copyright 
#   notice="lm-source-program" 
#   pids="5724-H72," 
#   years="2023" 
...
#   </copyright> 
#
#   post trans script for the MQSeriesJRE package
TARFLAGS='-xzf'
echo ${SHELLOPTS} | grep xtrace > /dev/null
if [ $? -eq 0 ] ; then
  TARFLAGS='-xvzf'
