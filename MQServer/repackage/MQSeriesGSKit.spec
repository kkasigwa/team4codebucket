...
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.55.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.55.mqtag
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.55.mqtag
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/runmqakm $RPM_BUILD_ROOT/opt/mqm/bin/runmqakm
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/runmqakm
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/runmqktool $RPM_BUILD_ROOT/opt/mqm/bin/runmqktool
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/runmqktool
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqcgskv32 $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv32
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv32
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqcgskv64 $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv64
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv64
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqigski $RPM_BUILD_ROOT/opt/mqm/bin/amqigski
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/bin/amqigski
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/gskit8/gskssl32.tar.gz $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl32.tar.gz
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl32.tar.gz
install /build/jslot0/p940_P/obj/amd64_linux_2/ship/opt/mqm/gskit8/gskssl64.tar.gz $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl64.tar.gz
touch -t '202406061327' $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl64.tar.gz
...
%attr(555,mqm,mqm) "/opt/mqm/bin/runmqktool"
...
## @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/gskit_postinstall.sh
##   <copyright 
##   notice="lm-source-program" 
##   pids="5724-H72" 
##   years="2010,2014" 
...
## @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/gskit_preuninstall.sh
##   <copyright 
##   notice="lm-source-program" 
##   pids="5724-H72" 
##   years="2010,2020" 
...
if [ ${MQ_UPGRADE} = "No" ] ; then 
  ...
  #######################################################
  #   Call amqigski -r to remove the untared files 
  #######################################################
  if [ -x  ${MQ_INSTALLATION_PATH}/bin/amqigski ] ; then 
...
## @(#) MQMBID sn=p940-L240606.TRIAL su=_kuor4iPzEe-M5d-9sa1WMw pn=install/unix/linux_2/gskit_posttrans.sh
##   <copyright 
##   notice="lm-source-program" 
##   pids="5724-H72" 
##   years="2023" 
...
#####################################################################################
#
#  Check GSKit was installed if this was an upgrade
#
#####################################################################################
# Check if we already unzipped and if not run again (old upgrades would delete the folder)
if [ ! -d ${GSKIT_HOME}/lib64 ]; then
  ${MQ_RUNSCRIPT} ${MQ_INSTALLATION_PATH}/bin/amqigski -i
  if [ $? -ne 0 ] ; then 
    exitval=2
    echo "WARNING:   GSKit Postinstall failed - see previous messages" >&2
